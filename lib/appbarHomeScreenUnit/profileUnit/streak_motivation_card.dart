            ...
            child: _isExpanded
                ? Padding(
                    ...
                    child: Text(
                      ...
                      'روزشمار نشان میده چند روز پشت‌سرهم برنامه را باز کرده‌ای.\n'
                      'هر روزی که وارد برنامه بشی، یک روز به این عدد اضافه میشه.\n'
                      'اگر حتی یک روز وارد برنامه نشی، شمارنده از صفر شروع میشه.\n'
                      'بیشترین روزی که وارد برنامه بشی هم به عنوان رکوردت ثبت میشه',
                      style: theme.textTheme.bodySmall?.copyWith(
                        height: 1.7,
                        fontSize: 15,
                        color: isNewRecord
