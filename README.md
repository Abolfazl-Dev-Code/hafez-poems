...
- 📚 مجموعه کامل اشعار حافظ — غزلیات، رباعیات، قصاید، قطعات و منتسب
- 🎧 پخش صوتی غزل‌ها با روایت از طریق گنجور
- 🔍 جستجوی سریع در تمام اشعار
- ❤️ علاقه‌مندی‌، ذخیره و برگزیده‌ اشعار مورد علاقه
- 🎴 فال حافظ
